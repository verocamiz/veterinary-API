...
namespace veterinary_API
{
    ...
    public class VeterinariesController : ControllerBase
    {
        ...
        private readonly VeterinaryBusinessLogic _VeterinaryBusinessLogic;

        public VeterinariesController(VeterinaryContext context, VeterinaryBusinessLogic veterinaryBusinessLogic)
        {
            _context = context;
